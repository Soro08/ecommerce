  ...
  var loadMyCartEvent = function(userOptions){
    ...
    if(!$("#" + idCartModal).length) {
      $('body').append(
        ...
        '<a href="http://127.0.0.1:8000/checkout/" class="btn btn-primary btn-sm">Checkout</a>' +
        '</div>' +
        '</div>' +
        '</div>' +
        '</div>'
    ...
    var drawTable = function(){
      ...
      $.each(products, function(){
        ...
        $cartTable.append(
          ...
          '<td>' + this.name + '</td>' +
          '<td title="Unit Price">' + this.price + 'fr</td>' +
          ...
          '<td title="Total" class="' + classProductTotal + '">' + total + 'fr</td>' +
      ...
      $cartTable.append(products.length ?
        ...
        '<td></td>' +
        '<td></td>' +
        '<td><strong id="' + idGrandTotal + '"> fr</strong></td>' +
        '<td></td>' +
        '</tr>'
    ...
    var showGrandTotal = function(products){
      ...
      $("#" + idGrandTotal).text(total+ " fr");
    }
    var showDiscountPrice = function(products){
      $("#" + idDiscountPrice).text(options.getDiscountPrice(products) + " fr");
    }
    ...
    */
    ...
    $(document).on("input", "." + classProductQuantity, function () {
      ...
      $(this).parent("td").next("." + classProductTotal).text(price * quantity + " fr");
